...
def create
  date1 =Date.parse("#{params[:m1]}"+"-"+"#{params[:d1]}"+"-"+"#{params[:y1]}")
  date2 =Date.parse("#{params[:m2]}"+"-"+"#{params[:d2]}"+"-"+"#{params[:y2]}")
  time1 =Tiime.parse("#{params[:timestart1]}"+":"+"#{params[:timestart2]}"+"#{params[:timestart2]}")
  time2 =Tiime.parse("#{params[:timeend1]}"+":"+"#{params[:timeend2]}"+"#{params[:timeend2]}")
